...
public class Frames extends JFrame implements ActionListener
{
	...
	public Frames()
	{
		...
		JLabel pinsToRelease = new JLabel("Pins to be Released");
		pinsToRelease.setBounds(30, 140, 200, 20);
		contentPane.add(pinsToRelease);
		...
		JLabel noreads = new JLabel("No-reads");
		noreads.setBounds(260, 140, 150, 20);
		contentPane.add(noreads);
